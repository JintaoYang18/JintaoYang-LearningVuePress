...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p>Reference:</p>`,6),j={href:"https://vuepress-plugin-blog.billyyyyy3320.com/guide/getting-started.html#frontmatter-classifier",target:"_blank",rel:"noopener noreferrer"},P=s("Frontmatter Classifier"),D=t(`<h2 id="globalpagination" tabindex="-1"><a class="header-anchor" href="#globalpagination" aria-hidden="true">#</a> globalPagination</h2><ul><li>Type: <code>object</code></li><li>Default: <code>{ lengthPerPage: 5 }</code></li></ul><p>Pagination config for all directories and frontmatters. For example:</p><div class="language-JavaScript ext-JavaScript line-numbers-mode"><pre class="language-JavaScript"><code>{
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,4),C=s("For more information, please visit "),L={href:"https://vuepress-plugin-blog.billyyyyy3320.com/pagination/#sorter",target:"_blank",rel:"noopener noreferrer"},Y=s("Pagination Config"),q=s("."),F=t(`<h2 id="sitemap" tabindex="-1"><a class="header-anchor" href="#sitemap" aria-hidden="true">#</a> sitemap</h2><ul><li>Type: <code>object</code></li><li>Default: <code>undefined</code></li></ul><p>You can simply enable it by filling out <code>hostname</code> property with your host name:</p><div class="language-JavaScript ext-JavaScript line-numbers-mode"><pre class="language-JavaScript"><code>{
  hostname: &#39;https://yourdomain&#39;
}
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br></div></div>`,4),I=s("Please head "),M={href:"https://github.com/ekoeryanto/vuepress-plugin-sitemap#options",target:"_blank",rel:"noopener noreferrer"},A=s("vuepress-plugin-sitemap"),W=s(" for more details."),E=t(`<h2 id="comment" tabindex="-1"><a class="header-anchor" href="#comment" aria-hidden="true">#</a> comment</h2><ul><li>Type: <code>object</code></li><li>Default: <code>undefined</code></li></ul><p>Vssue and Disqus are our built-in comment services. Here&#39;s the required properties to enable:</p><div class="language-JavaScript ext-JavaScript line-numbers-mode"><pre class="language-JavaScript"><code>// Disqus
{
  service: &quot;disqus&quot;,
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br></div></div><h2 id="paginationcomponent" tabindex="-1"><a class="header-anchor" href="#paginationcomponent" aria-hidden="true">#</a> paginationComponent</h2><ul><li>Type: <code>string</code></li><li>Default: <code>&#39;Pagination&#39;</code></li></ul><p>Custom the pagination component.</p>`,5),jn=s("The default is the "),Pn={href:"https://vuepress-plugin-blog.billyyyyy3320.com/components/#pagination",target:"_blank",rel:"noopener noreferrer"},Dn=s("pagination component"),Cn=s(" powerful by "),Ln={href:"https://github.com/ulivz/vuepress-plugin-blog",target:"_blank",rel:"noopener noreferrer"},Yn=s("@vuepress/plugin-blog"),qn=s(":"),Fn=n("img",{src:u,width:"250",height:"",style:{}},null,-1),In=s("You can set this option to "),Mn=n("code",null,"SimplePagination",-1),An=s(" to enable another out-of-box "),Wn={href:"https://vuepress-plugin-blog.billyyyyy3320.com/components/#simplepagination",target:"_blank",rel:"noopener noreferrer"},En=s("simple pagination component"),Rn=s(":"),Vn=t('<img src="'+d+`" width="250" height="" style=""><p>You can also write a custom pagination component and register it as a global component. then pass its name to this option.</p><h2 id="smoothscroll" tabindex="-1"><a class="header-anchor" href="#smoothscroll" aria-hidden="true">#</a> smoothScroll</h2><ul><li>Type: <code>boolean</code></li><li>Default: <code>false</code></li></ul><p>The <code>themeConfig.smoothScroll</code> option allows you to enable smooth scrolling.</p><div class="language-JavaScript ext-JavaScript line-numbers-mode"><pre class="language-JavaScript"><code>// .vuepress/config.js
module.exports = {
  themeConfig: {
    smoothScroll: true
  }
}
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div>`,6);function Bn(Nn,Hn){const r=o("RouterLink"),a=o("ExternalLinkIcon");return l(),i(c,null,[h,g,f,n("p",null,[_,e(r,{to:"/config/front-matter.html#date"},{default:p(()=>[y]),_:1}),k,n("a",v,[x,e(a)])]),S,n("ul",null,[n("li",null,[n("a",w,[J,e(a)])])]),T,n("ul",null,[n("li",null,[n("a",j,[P,e(a)])])]),D,n("p",null,[C,n("a",L,[Y,e(a)]),q]),F,n("p",null,[I,n("a",M,[A,e(a)]),W]),E,n("p",null,[R,n("a",V,[B,e(a)])]),N,n("ul",null,[n("li",null,[n("a",H,[U,e(a)])]),n("li",null,[n("a",z,[O,e(a)])])]),G,n("p",null,[K,n("a",Q,[X,e(a)]),Z,$,nn]),sn,n("p",null,[en,n("a",an,[tn,e(a)]),rn]),on,n("div",pn,[ln,n("p",null,[cn,n("a",un,[dn,e(a)]),bn,mn,hn])]),gn,fn,n("p",null,[_n,e(r,{to:"/config/front-matter.html#summary"},{default:p(()=>[yn]),_:1}),kn]),vn,n("p",null,[xn,n("a",Sn,[wn,e(a)]),Jn]),Tn,n("p",null,[jn,n("a",Pn,[Dn,e(a)]),Cn,n("a",Ln,[Yn,e(a)]),qn]),Fn,n("p",null,[In,Mn,An,n("a",Wn,[En,e(a)]),Rn]),Vn],64)}var Gn=b(m,[["render",Bn]]);export{Gn as default};
